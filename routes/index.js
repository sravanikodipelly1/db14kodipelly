...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Manager App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Manager App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Manager App Login', user : req.user }); 
}); 
